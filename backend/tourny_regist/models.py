...
class Tournament(models.Model):
    ...
    contact_emergency_phone = models.CharField(max_length=30, blank=True)
    ...
    company_registration_certificate = models.FileField(
        upload_to='tournaments/company_registration_certificate/%Y/%m/', blank=True, null=True,
    )
    business_license = models.FileField(upload_to='tournaments/business_license/%Y/%m/', blank=True, null=True)
    organizer_cnic_front = models.FileField(upload_to='tournaments/organizer_cnic_front/%Y/%m/', blank=True, null=True)
    organizer_cnic_back = models.FileField(upload_to='tournaments/organizer_cnic_back/%Y/%m/', blank=True, null=True)
    tax_certificate = models.FileField(upload_to='tournaments/tax_certificate/%Y/%m/', blank=True, null=True)
    sponsor_agreement = models.FileField(upload_to='tournaments/sponsor_agreement/%Y/%m/', blank=True, null=True)
...
class Registration(models.Model):
    ...
    payment_proof = models.FileField(upload_to='registrations/payment_proof/%Y/%m/', blank=True, null=True)
