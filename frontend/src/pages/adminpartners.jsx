    ...
    <tr className="border-b border-border/40 bg-muted/20">
      <td colSpan={5} className="px-4 py-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <input type="number" placeholder="Display order" value={form.display_order} onChange={(e) => setForm({ ...form, display_order: Number(e.target.value) || 0 })} className="px-3 py-2 rounded-lg bg-muted/40 border border-border text-sm outline-none focus:border-primary" />
